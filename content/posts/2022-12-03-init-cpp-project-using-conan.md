...
[갤럭시 탭 S7(안드로이드 태블릿) 에서 vscode 사용하기 (feat. vscode-server, vscode.dev)](https://mumbi.net/dev-tips/%EA%B0%A4%EB%9F%AD%EC%8B%9C%ED%83%ADS7-vscode-%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0-vscode-server)
